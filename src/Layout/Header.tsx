   ...
   <div className="container mx-auto">
     <header className=" bg-white ">
      <div className=" w-full mx-auto px-4 py-4 flex justify-between items-center">
        {/* Logo Section */}
        <div className="flex items-center space-x-2 " onClick={() => router.push("/home")}>
          <span  className="cursor-pointer text-3xl font-bold tracking-tight text-black">
        ...
        <nav className="hidden lg:flex items-center space-x-8">
          ...
          <div className="relative">
            ...
            {isDropdownOpen && (
              <div className="absolute top-full left-0 mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg py-2 z-10">
        ...
        <div className="hidden lg:flex items-center space-x-4">
          ...
          <button onClick={() => router.push("/Auth/signin")}  className="cursor-pointer bg-orange-500 hover:bg-orange-600 text-white font-medium py-2 px-6 rounded-full transition-colors duration-200 shadow-md">
            Login
          </button>
        </div>

        {/* Mobile menu button (you would add a full mobile menu here) */}
