...
export default function YouTubeCarousel() {
  ...
  useEffect(() => {
    if (youtubeSort?.success && youtubeSort?.videos) {
      const videoIds = youtubeSort.videos.map((video: any) => 
      ...
      <div className="w-full bg-gray-50 py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-10 text-center">
             ...
             <p className="text-gray-500 mt-2">Latest highlights from our community</p>
          </div>
          ...
          {videos.length > 0 ? (
                ...
                <SwiperSlide key={id}>
                  ...
                  >
                    ...
                    <img
                      ...
                      onError={(e: any) => e.target.src = `https://img.youtube.com/vi/${id}/hqdefault.jpg`}
                      alt="Thumbnail"
            ...
            <div className="flex gap-6 justify-center">
              {[1, 2, 3].map((i) => (
                <div key={i} className="w-[280px] aspect-[9/16] bg-gray-200 animate-pulse rounded-3xl" />
              ))}
            </div>
          )}
        </div>
