...
export default function MergedExamPageCUET() {
  return (
    <section className="min-h-screen w-full bg-white flex flex-col justify-between">
      ...
      {/* TOP CONTENT */}
      <div className="relative mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-28 w-full">
        
        {/* HEADER */}
        {/* <div className="bg-[#F4FBFF] rounded-[8px] py-12 text-center w-full mt-6">
          <h2 className="text-3xl md:text-4xl font-medium text-[#FF5635]">
            Plans and Pricing
          </h2>
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm md:text-base">
            Practice mock exams from multiple colleges and prepare with confidence.
          </p>
        </div> */}

        {/* COMING SOON CARD */}
        <div className="flex justify-center mt-12">
          <div className="bg-gray-100 rounded-[8px] flex flex-col min-h-[500px] w-full max-w-md">

            <div className="text-center p-6">
              <p className="text-xl font-medium text-[#727EA3]">
                CUET
              </p>
              <h3 className="text-lg text-[#727EA3] mt-1">
                Coming Soon
              </h3>
            </div>

            <div className="border-t border-gray-400 mx-6 my-4" />
            ...
            <div className="px-6 pb-6">
              <button
                disabled
                className="w-full py-3 rounded-[8px] bg-gray-400 text-white font-semibold cursor-not-allowed"
              >
                Coming Soon
              </button>
            </div>
      ...
      {/* FOOTER */}
      <section className="bg-[#FF5635] text-white py-8 px-6 mt-16">
