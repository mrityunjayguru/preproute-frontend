...
export default function SwitchSectionRestrictionPopup({
  onClose,
  onConfirm,
  selectedSection
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-2xl ">
        {/* Title */}
        <h2 className="text-xl font-medium text-[#FF5635] font-poppins">Ready to submit</h2>

        {/* Subtitle */}
        <p className="mt-2 text-gray-700 text-md font-dm-sans">
          Your  <span className="font-normal text-[#FF5635]">{selectedSection?.sectionDetail?.section}</span>{" "}
         Will be sealed and you will moved on to the  next section.
        </p>
