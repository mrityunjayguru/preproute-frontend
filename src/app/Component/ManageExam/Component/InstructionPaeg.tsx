...
export default function InstructionsPage() {
  ...
  return (
   ...
   <div className="w-full max-w-full bg-white rounded-2xl p-6 mt-6">
  <div className="flex items-center justify-between mb-4">
    ...
    >
      Start Exam
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
            <div className="flex items-center space-x-3">
              ...
              <p className="text-base">You have not visited the question yet.</p></div>
            <div className="flex items-center space-x-3">     <span className="text-[#ED3324]">
              {questionIcon}
            </span>
              <p className="text-base">You have not answered the question.</p></div>
            <div className="flex items-center space-x-3">     <span className="text-[#4FA77E]">
              {questionIcon}
            </span>
              <p className="text-base">You have answered the question</p></div>
            <div className="flex items-center space-x-3">     <span className="text-[#9555E1]">
              {questionIcon}
            </span>
              <p className="text-base">Marked for review.</p></div>
            <div className="flex items-center space-x-3">     <span className="text-[#870051]">
              {questionIcon}
            </span>
              <p className="text-base">Answered & Marked for Review will be evaluated.</p></div>
          </div>

          <p className="mt-3 text-base">
            The Marked for Review status simply indicates...
            <span className="text-[#FF5635]"> If a question is answered and marked for review, it will be evaluated.</span>
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-lg font-semibold mb-2">Navigating to a Question</h2>
        ...
        <section className="mb-8">
          <h2 className="text-lg font-semibold mb-2">Answering a Question</h2>
          <ul className="list-disc ml-6 space-y-2 text-base">
            <li>Procedure for answering:
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">Navigating through sections</h2>
          <ul className="list-disc ml-6 space-y-2 text-base">
