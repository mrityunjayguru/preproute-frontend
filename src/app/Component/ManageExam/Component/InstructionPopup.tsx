...
export default function InstructionPopup({ isOpen, onClose }: InstructionPopupProps) {
            ...
            <section className="mb-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-base">You have not visited the question yet.</p>
                </div>

                <div className="flex items-center space-x-3">
                  <span className="text-[#ED3324]">{questionIcon}</span>
                  <p className="text-base">You have not answered the question.</p>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-base">Answered & Marked for Review will be evaluated.</p>
                </div>
              </div>
              ...
              <p className="mt-3 text-base">
                ...
                <span className="text-[#FF5635]">
                  {" "}If a question is answered and marked for review, it will be evaluated.
                </span>
              </p>
            </section>
