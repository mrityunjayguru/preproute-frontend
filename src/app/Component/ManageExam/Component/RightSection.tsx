    ...
    <div className="lg:w-1/6 w-full flex flex-col font-semibold flex-shrink-0 mr-0 lg:mr-4 mt-6 lg:mt-0 lg:h-[76vh] h-auto">
      ...
      <div className="bg-[#F9FAFC] rounded-[8px] border border-[#E6F4FF] flex-shrink-0 mx-2 lg:mx-0">
        <div className="flex items-center bg-[#F9FAFC] p-2 rounded-[8px]">
          <div className="rounded-[8px] flex items-center justify-center mr-4 flex-shrink-0 overflow-hidden bg-gray-100 w-12 h-12 lg:w-16 lg:h-16">
          ...
          <div className="flex flex-col text-md lg:text-xl font-poppins">
            ...
            {Array.from({ length: totalNoOfQuestions }, (_, idx) => {
              ...
              return (
                <button
                  ...
                  disabled={isTimeUp}
                  className="relative flex items-center justify-center aspect-square font-bold transition hover:opacity-80 disabled:opacity-50 disabled:cursor-not-allowed w-full max-w-[40px] mx-auto"
                >
                  <Image src={iconSrc} alt={`Q ${idx + 1}`} width={34} height={34} className="w-full h-full object-contain" />
                  <span
                    className="absolute inset-0 flex items-center justify-center text-xs sm:text-sm font-medium font-poppins"
