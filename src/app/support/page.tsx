...
const SupportPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between items-center bg-white">
      <div></div>
      <div className="w-full max-w-xl border-none shadow-none px-4 sm:px-0">
        ...
        <div className="pb-4 ">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-xl sm:text-2xl font-medium font-poppins">Prep Support</h1>
            </div>
            <div className="flex items-center gap-3">
      ...
      <section
        className="w-full bg-[#FF5635] text-white mt-16 py-6 sm:py-8"
      >
        <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row items-center justify-between gap-8 px-6 sm:px-10 lg:px-16">
          <div
