...
function Analytics() {
  ...
  const yearOrNumberOptions = useMemo(() => {
    const selected = examList.find((e: any) => e?._id === selectedExamId);
    const years = selected?.years || selected?.year || [];
